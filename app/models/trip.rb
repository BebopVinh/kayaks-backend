  ...
  def self.get_image
    Trip.all.each do |trip|
      if trip.water_type == 'lake'
        ...
        @image = 'https://images.unsplash.com/photo-1497290756760-23ac55edf36f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60'
