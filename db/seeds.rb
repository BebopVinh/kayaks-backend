...
User.create(id: 2, name: 'john', password: '123')
User.create(id: 3, name: 'lola', password: '123')
...
Trip.create(id: 3, name: 'florida keys', water_type: 'flat', start_date: '9/4/19', end_date: '9/15/19')
